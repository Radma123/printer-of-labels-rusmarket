...
головки) x 72mm (вдоль подачи) — см. docs/decisions.md в корне проекта.
...
ложится на откалиброванный рулон. Направление поворота не проверялось
на реальном принтере (см. заметку в docs/current-state.md) — если первая
физическая этикетка ляжет текстом не в ту сторону, в приложении есть
чекбокс «повернуть на 180°».
...
# Физический рулон принтера (см. docs/decisions.md): 100mm поперёк головки,
